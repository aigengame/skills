<!-- skills-readme-i18n: source=README.md sha256=2e349d0fa9cc4a0e0e28e301b4af95907992d16fb832991113c0962840b909ea -->
...
- **何时使用：** 功能或修复反复不收敛，或辅助机制持续膨胀时使用；不能仅凭迭代次数判定设计错误。
